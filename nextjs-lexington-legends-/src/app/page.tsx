      ...
      <main className="flex-grow container mx-auto p-8">
        <section className="mb-12">
          <div className="bg-blue-700 text-white p-8 rounded-lg shadow-lg">
            <h2 className="text-4xl font-bold mb-4">Welcome to Lexington Legends</h2>
            <p className="text-xl mb-6">Your premier baseball team in the heart of Kentucky</p>
            <Link href="/schedule" className="bg-white text-blue-800 px-6 py-2 rounded-lg font-bold hover:bg-blue-100 transition-colors">
              View Schedule
            </Link>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-blue-800">Upcoming Games</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {upcomingGames.length > 0 ? (
              upcomingGames.map((game) => {
                ...
                return (
                  <div key={game._id} className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className={game.location === "Home" ? "text-green-600" : "text-blue-600"}>
                        {game.location} Game
                      </span>
                    </div>
          ...
          <div className="mt-4 text-center">
            <Link href="/schedule" className="text-blue-700 hover:text-blue-900 font-medium">
              View Full Schedule →
            </Link>
          </div>
        </section>
        ...
        <section className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-100 p-6 rounded-lg shadow">
            ...
            <p>Stay up to date with the latest team news, trades, and announcements.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow">
