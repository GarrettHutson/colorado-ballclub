            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="md:w-1/2">
                <h1 className="text-5xl md:text-6xl font-bold mb-4 animate-fade-in-up">
                  ...
                  <span className="block text-yellow-300">Ballclub</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 max-w-lg animate-fade-in-up animation-delay-300">
                  Your premier baseball team in the heart of Colorado. Join us
                  for a season of thrilling games, great entertainment and
              ...
              {upcomingGames.length > 0 ? (
                upcomingGames.map((game, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`h-2 ${game.location === "Home" ? "bg-green-500" : "bg-blue-500"}`}
                      ></div>
                ...
                <div className="col-span-3 bg-white p-8 rounded-xl text-center shadow-md">
                  ...
                  <p className="text-gray-600">
                    Our schedule is being updated. Check back soon for the
          ...
          <section className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300 hover:shadow-xl border-t-4 border-blue-600">
              ...
              <p className="text-gray-600 mb-6">
                ...
                announcements from the Colorado Ballclub.
              </p>
              <a
                href="#"
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300 hover:shadow-xl border-t-4 border-blue-600">
              ...
              <p className="text-gray-600 mb-6">
                Meet our players and coaching staff for the current season. Get
                to know the team behind the Ballclub' success.
              </p>
              <a
                href="#"
                className="inline-flex items-center text-blue-600 font-medium group"
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300 hover:shadow-xl border-t-4 border-blue-600">
              ...
              <p className="text-gray-600 mb-6">
                Get the latest Colorado Ballclub merchandise and apparel. Show
                your support with official team gear.
              </p>
              <a
                href="#"
                className="inline-flex items-center text-blue-600 font-medium group"
          ...
          <section className="bg-gradient-to-r from-blue-700 to-blue-600 rounded-2xl overflow-hidden shadow-xl">
            <div className="px-8 py-12 md:py-16 text-center text-white relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Join the Ballclub Community
              </h2>
              <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-8">
                Be part of the excitement! Sign up for our newsletter to get the
                latest updates, exclusive content, and special offers.
              </p>
