...
import { getUpcomingGames, getGamesByDateRange, getGames } from "../../lib/sanity";
          ...
          <div className="md:col-span-1">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>For group tickets (10 or more), please call our ticket office at (555) 123-4567</li>
                    ...
                    {games.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan={5} className="px-6 py-8 text-center text-gray-500">
                          No games found for the selected date range. Try adjusting your filters.
                        </td>
                      </tr>
                    )}
                  </tbody>
