            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2">
                  Colorado Ballclub vs {game.opponent}
                </h1>
                <div className="flex items-center text-blue-100">
                  <span
                    className={`inline-block w-3 h-3 rounded-full mr-2 ${game.location === "Home" ? "bg-green-400" : "bg-yellow-400"}`}
                  ></span>
          ...
          <div className="p-6 md:p-8">
                ...
                {game.locationImageUrl ? (
                  <div className="rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="p-3 bg-gray-800 text-gray-200 text-sm">
                      {game.location} Stadium - Home of the{" "}
                      {game.location === "Home"
                        ? "Colorado Ballclub"
                        : game.opponent}
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-100 to-blue-50 rounded-lg p-6 h-full flex items-center justify-center border border-blue-200">
                    <div className="text-center">
                      ...
                      <p className="text-blue-700">
                        Stay tuned for game photos and highlights!
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="mt-10 border-t border-gray-200 pt-6">
              ...
              <p className="text-gray-600">
                Join us for this exciting matchup between the Colorado Ballclub
                and the {game.opponent}!
                {game.location === "Home"
                  ? " Cheer on your Ballclub at home as they face off against a tough opponent."
