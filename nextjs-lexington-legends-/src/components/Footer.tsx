        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold">Lexington Legends</span>
              <span className="ml-2 text-yellow-400 text-2xl">⚾</span>
            </div>
            <p className="text-blue-100 mb-6">
              Your premier baseball team in the heart of Kentucky, bringing excitement and community pride since 2001.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="bg-white/10 hover:bg-white/20 w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-blue-100 hover:text-yellow-300 transition-colors duration-300 flex items-center">
              ...
              <li>
                <a href="/promotions" className="text-blue-100 hover:text-yellow-300 transition-colors duration-300 flex items-center">
                  <svg className="w-3 h-3 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path>
                  </svg>
                  Promotions
          ...
          <div>
            ...
            <address className="not-italic">
              <div className="flex items-start mb-3">
                <svg className="w-5 h-5 text-yellow-400 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center mb-3">
                <svg className="w-5 h-5 text-yellow-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@lexingtonlegends.com" className="text-blue-100 hover:text-yellow-300 transition-colors duration-300">info@lexingtonlegends.com</a>
              </div>
            </address>
          </div>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg font-bold mb-4 border-b border-blue-700 pb-2">Newsletter</h3>
        ...
        <div className="border-t border-blue-700 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm text-blue-200">
              ...
              <a href="#" className="hover:text-yellow-300 transition-colors duration-300">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
